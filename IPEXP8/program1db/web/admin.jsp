<%-- 
    Document   : admin
    Created on : 31-Mar-2024, 9:20:12 am
    Author     : DELL
--%>
    ...
    <%
        ...
        try {
            ...
            if (con != null) {
                ...
                out.print("<thead><tr><th>Book Code</th><th>Book Name</th><th>Author</th><th>Price</th></tr></thead>");
                out.print("<tbody>");
                while (rsAllBooks.next()) {
                    out.print("<tr><td>" + rsAllBooks.getInt(1) + "</td><td>" + rsAllBooks.getString(2) + "</td>"
                            + "<td>" + rsAllBooks.getString(3) + "</td><td>" + rsAllBooks.getDouble(4) + "</td></tr>");
                }
                out.print("</tbody>");
                ...
                if (rsHighPriceBook.next()) {
                    out.print("<h3>HIGH COST BOOK : " + rsHighPriceBook.getString(1) + " PRICE : "
                            + rsHighPriceBook.getDouble(2) + "</h3>");
                }
